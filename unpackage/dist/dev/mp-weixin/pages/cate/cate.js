...
const common_cateTpey = require("../../common/cateTpey.js");
const _sfc_main = {
  data() {
    return {
      name: "wkiwi",
      ...
      scrollTop: 0,
      scrollLeftTop: 0,
      classifyData: common_cateTpey.classifyData,
  ...
  methods: {
    getHeightList() {
      ...
      selectorQuery.selectAll(".nav-left-item").boundingClientRect(function(rects) {
        ...
        _this.navLeftHeight = _this.leftItemHeight * common_cateTpey.classifyData.length;
      ...
      this.timeoutId = setTimeout(function() {
        ...
        for (let i = 0; i < _this.arr.length; i++) {
          ...
          if (!height2 || _this.scrollHeight >= height1 && _this.scrollHeight < height2) {
            ...
            _this.diff > 0 && (_this.scrollLeftTop = Math.round(_this.categoryActive * _this.diff / (common_cateTpey.classifyData.length - 1)));
            return false;
          }
        }
      ...
      return {
        ...
        b: common_vendor.f(foods.foods, (item, i, i1) => {
          return {
            ...
            b: i == 0 ? "first" : "",
            c: i,
            d: common_vendor.o(($event) => $options.cart(item.cat), i)
          };
        }),
        c: index
      };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/test/fireDemo/pages/cate/cate.vue"]]);
